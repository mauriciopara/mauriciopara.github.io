...
class IndexView {
  ...
  createCategories(catList) {
    ...
    divInstructions.innerHTML =
      "Substituimos arroz branco por arroz integral ou frito depois de 15:00 por um adicional de $1.5 por porção.";
  ...
  createCat(cat) {
    ...
    let boxCat = `<div class="col-md-3 col-sm-4 col-xs-6 col-xxs-12">
  ...
  showTotal(pedido){
    ...
    if (pedido.total) {
      totalObj.innerHTML = `$: ${pedido.total.toFixed(2)}`;
    }
  }
    ...
    let card = `<div class="menu-item-tile col-md-6">
                        <div class="row">
                            <div class="col-sm-5">
                                ...
                                <div>
                                    <span> </span>$: ${dish.price.toFixed(2)} 
                                    <span></span>
                                </div>
                            </div>
    ...
    knownOrders.forEach(e => {
        ...
        <div class="menu-item-tile col-md-6">
              <div class="row">
                  <div class="col-sm-5">
                      <div class="menu-item-photo">
                          <div class="menu-item">${e.code}</div>
                          <img class="img-responsive" 
                          src="${e.photo}" alt="Item" 
                          width="250" height="150">
                      </div>
                  </div>
                  <div class="menu-item-description col-sm-7">
                      ...
                      <p>${e.quantity}x</p>
                      <button id="${e.code}" class="btn btn-primary excluir">Excluir</button>
                  </div>
              </div>
              <hr class="visible-xs">

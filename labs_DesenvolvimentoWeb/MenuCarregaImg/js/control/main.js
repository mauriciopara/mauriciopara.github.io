 ...
 */
 document.addEventListener("click", (event) =>{
    ...
    if(event.target.matches("#menu .edit img")){
        ...
        if(newFood.name == "" && newFood.image == "") {alert("Campo 'Nome' e 'Imagem' vazios")}
        else if(newFood.name == "") {alert("Campo 'Nome' vazio")}
        else if(newFood.image == "") {alert("Campo 'Image' vazio")}
